...
from stats_analysis.print_info import create_stats, create_report


def main():
    file_name = 'data/stats_data.xlsx'
    try:
        ...
        with pd.ExcelWriter('data/stats_data.xlsx', mode='a', if_sheet_exists='replace') as writer:
